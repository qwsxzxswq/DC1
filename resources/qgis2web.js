...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 23, minZoom: 12
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
//map.getView().fit([13372273.093403, 2621068.663906, 13388756.087044, 2632538.119920], map.getSize());


setTimeout(function() {
    // 根據圖片中顯示的範圍設置新的坐標
    // 這些坐標是根據圖片中顯示的台南市區域估算的
    map.getView().fit([13372273.093403, 2621068.663906, 13388756.087044, 2632538.119920], map.getSize());
    console.log("地圖範圍已設置為圖片範圍");
}, 500);
